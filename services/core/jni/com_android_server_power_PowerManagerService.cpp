...
#include <vendor/elytra/power/Feature.h>
#include <vendor/elytra/power/IPowerFeature.h>
#include "jni.h"
...
using PowerFeature = vendor::elytra::power::Feature;
using vendor::elytra::power::IPowerFeature;
